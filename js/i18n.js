...
const STRINGS = {
    en: {
        ...
        'menu.credits': 'Made with ❤️ at<br><a href="https://ter.univie.ac.at/" target="_blank" rel="noopener">Terrestrial Ecosystem Research</a><br><a href="https://cemess.univie.ac.at/" target="_blank" rel="noopener">CeMESS</a> · University of Vienna',

        // ===== Funny Commentary Quips (pipe-delimited) =====
        'quip.atmoWarning': "The cows are coughing...|Someone opened a chemistry set!|The air tastes... crunchy?|Even the worms want a gas mask.|N₂O ppm rising... not ideal.|The partial pressure of regret is increasing.|Boltzmann would not approve of this entropy.|This air violates the Clean Air Act.|pH of the rain looking suspicious...|Charles' Law says this gas is expanding. Yikes.",
        'quip.atmoCritical': "Is that smog or a BBQ gone wrong?|The atmosphere called. It wants a refund.|Congratulations, you invented smog!|The sky is literally crying.|300x worse than CO₂. Just saying.|You're speedrunning climate change!|The IPCC wants to have a word with you.|Earth's energy budget is NOT balanced.|This is giving Anthropocene vibes.|Radiative forcing: it's not a feature.",
        'quip.waterWarning': "The fish are filing complaints.|The frogs moved out. Thanks.|That water looks... chunky.|Algae says thanks for the buffet!|Eutrophication in progress...|The nitrate is leaching. Classic.|Liebig's Law says: too much of a good thing.|This groundwater needs therapy.|The water table is judging you.|NO₃⁻ in the aquifer? That's a paddlin'.",
        'quip.waterCritical': "RIP fish. You did this.|Dead zone achieved! ...wait, that's bad.|The river filed a restraining order.|Even the algae gave up.|Hypoxia unlocked! Fish hate this trick.|You created a dead zone. Gulf of Mexico says hi.|Dissolved O₂: basically zero. Nice.|The benthos community has left the chat.|Congrats, you eutrophied a whole ecosystem.|Marine biologists are typing...",
        'quip.plantDying': "Your plant is writing its will...|The plant just sighed. Plants can't sigh.|SOS from the root zone!|Your plant googled 'new owner'.|Turgor pressure: critically low.|The chloroplasts are on strike.|Wilting coefficient exceeded!|Your plant's stomata are screaming.|Rubisco has left the building.|Photosystem II is filing for bankruptcy.",
        'quip.tempHigh': "Even the bacteria need sunscreen!|It's not a heatwave, it's your fault.|The soil is filing a heat complaint.|Thermometer says: NOPE.|Enzyme denaturation in 3... 2...|The Arrhenius equation is crying.|Q₁₀ says reaction rates are out of control.|Mesophiles becoming thermophiles. Uh oh.|The soil microbiome needs AC.|Heat shock proteins: activated!",
        'quip.n2oSpike': "The ozone layer sends its regards.|Greenhouse effect goes brrr...|That's a lot of laughing gas!|The climate just facepalmed.|298x the warming potential of CO₂!|Incomplete denitrification strikes again.|Pseudomonas tried its best, okay?|N₂O: the greenhouse gas nobody talks about.|Your radiative forcing contribution: noted.|The Haber-Bosch process is rolling in its grave.",
        'quip.manure': "Special delivery from the cow!|Organic currency deposited!|The cow has spoken.|Moo-ney drop!|Ammonification starter pack!|The rumen has spoken.|C:N ratio just shifted. You're welcome.|Urea cycle in action!|Organic N: farm-to-soil fresh!|The dung beetle approves.",
    ...
    de: {
        ...
        'menu.credits': 'Mit ❤️ entwickelt am<br><a href="https://ter.univie.ac.at/" target="_blank" rel="noopener">Terrestrial Ecosystem Research</a><br><a href="https://cemess.univie.ac.at/" target="_blank" rel="noopener">CeMESS</a> · Universität Wien',

        // ===== Lustige Kommentare (pipe-getrennt) =====
        'quip.atmoWarning': "Die Kühe husten...|Wer hat das Chemielabor geöffnet?|Die Luft schmeckt... knusprig?|Selbst die Würmer wollen Gasmasken.|N₂O-ppm steigen... nicht ideal.|Der Partialdruck des Bedauerns steigt.|Boltzmann würde diese Entropie nicht gutheißen.|Diese Luft verletzt das Luftreinhaltegesetz.|Der pH des Regens sieht verdächtig aus...|Charles' Gesetz sagt: dieses Gas dehnt sich aus. Autsch.",
        'quip.atmoCritical': "Ist das Smog oder ein Grillunfall?|Die Atmosphäre will eine Rückerstattung.|Glückwunsch, du hast Smog erfunden!|Der Himmel weint buchstäblich.|300x schlimmer als CO₂. Nur so gesagt.|Du speedrunnst den Klimawandel!|Der IPCC möchte ein Wort mit dir.|Die Energiebilanz der Erde ist NICHT ausgeglichen.|Das gibt Anthropozän-Vibes.|Strahlungsantrieb: kein Feature.",
        'quip.waterWarning': "Die Fische beschweren sich.|Die Frösche sind ausgezogen. Danke.|Das Wasser sieht... stückig aus.|Algen sagen danke fürs Buffet!|Eutrophierung im Gange...|Das Nitrat sickert. Klassiker.|Liebigs Gesetz: zu viel des Guten!|Dieses Grundwasser braucht Therapie.|Der Grundwasserspiegel verurteilt dich.|NO₃⁻ im Aquifer? Das gibt Ärger.",
        'quip.waterCritical': "RIP Fische. Das war dein Werk.|Tote Zone erreicht! ...Moment, das ist schlecht.|Der Fluss hat eine einstweilige Verfügung beantragt.|Selbst die Algen haben aufgegeben.|Hypoxie freigeschaltet! Fische hassen diesen Trick.|Du hast eine Totzone erschaffen. Golf von Mexiko grüßt.|Gelöster O₂: praktisch null. Toll.|Die Benthos-Gemeinschaft hat den Chat verlassen.|Gratulation, ganzes Ökosystem eutrophiert.|Meeresbiologen tippen...",
        'quip.plantDying': "Deine Pflanze schreibt ihr Testament...|Die Pflanze hat geseufzt. Pflanzen können nicht seufzen.|SOS aus der Wurzelzone!|Deine Pflanze googelt 'neuer Besitzer'.|Turgordruck: kritisch niedrig.|Die Chloroplasten streiken.|Welkepunkt überschritten!|Die Stomata deiner Pflanze schreien.|Rubisco hat das Gebäude verlassen.|Photosystem II meldet Insolvenz an.",
        'quip.tempHigh': "Selbst die Bakterien brauchen Sonnencreme!|Das ist keine Hitzewelle, das bist du.|Der Boden beschwert sich über die Hitze.|Thermometer sagt: NEIN.|Enzymdenaturierung in 3... 2...|Die Arrhenius-Gleichung weint.|Q₁₀ sagt: Reaktionsraten außer Kontrolle!|Mesophile werden zu Thermophilen. Oje.|Das Bodenmikrobiom braucht eine Klima-Anlage.|Hitzeschockproteine: aktiviert!",
        'quip.n2oSpike': "Die Ozonschicht lässt grüßen.|Treibhauseffekt geht brrrr...|Das ist viel Lachgas!|Das Klima macht einen Facepalm.|298x das Erwärmungspotenzial von CO₂!|Unvollständige Denitrifikation schlägt wieder zu.|Pseudomonas hat sein Bestes versucht, okay?|N₂O: das Treibhausgas, über das keiner redet.|Dein Strahlungsantrieb-Beitrag: notiert.|Das Haber-Bosch-Verfahren dreht sich im Grab um.",
        'quip.manure': "Sonderlieferung von der Kuh!|Organische Währung deponiert!|Die Kuh hat gesprochen.|Muh-nzen gefallen!|Ammonifikation-Starterpaket!|Der Pansen hat gesprochen.|C:N-Verhältnis verschoben. Gern geschehen.|Harnstoffzyklus in Aktion!|Organischer N: frisch vom Feld!|Der Mistkäfer ist begeistert.",
        ...
        'speed.quarter': 'Viertelgeschwindigkeit',
